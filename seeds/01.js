...
exports.seed = function(knex, Promise) {
  ...
  return knex.raw('DELETE FROM "book_author"; ALTER SEQUENCE book_author_id_seq RESTART WITH 1')
  .then(()=>{
    return knex.raw('DELETE FROM "book"; ALTER SEQUENCE book_id_seq RESTART WITH 1')
  })
  .then(()=>{
    return knex.raw('DELETE FROM "author"; ALTER SEQUENCE author_id_seq RESTART WITH 1')
  })
    .then(function () {
      return Promise.all([
